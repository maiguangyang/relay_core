...
void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) flutter_sfu_relay_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "ScreenSharePlugin");
  screen_share_plugin_register_with_registrar(flutter_sfu_relay_registrar);
